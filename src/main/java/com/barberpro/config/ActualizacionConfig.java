...
public class ActualizacionConfig {
    ...
    private static void cargarConfiguracion() {
        ...
        if (configFile.exists()) {
            ...
            props.setProperty("app.repo", "Miller38/BarberProSystem");
    ...
    private static void guardarConfiguracion() {
        try (FileOutputStream fos = new FileOutputStream(CONFIG_FILE)) {
            props.store(fos, "Configuracion de BarberProSystem");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public static String getRepo() {
        return props.getProperty("app.repo", "Miller38/BarberProSystem");
    }
